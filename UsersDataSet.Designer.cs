...
namespace Clinic {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(int userID, string userName, string userPassword, string userMail, bool Admin) {
...
namespace Clinic.UsersDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([userID], [userName], [userPassword], [userMail], [Adm" +
                "in]) VALUES (@userID, @userName, @userPassword, @userMail, @Admin);\r\nSELECT user" +
                "ID, userName, userPassword, userMail, Admin FROM Users WHERE (userID = @userID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [userID] = @userID, [userName] = @userName, [userPassword] = @userPassword, [userMail] = @userMail, [Admin] = @Admin WHERE (([userID] = @Original_userID) AND ([userName] = @Original_userName) AND ((@IsNull_userPassword = 1 AND [userPassword] IS NULL) OR ([userPassword] = @Original_userPassword)) AND ((@IsNull_userMail = 1 AND [userMail] IS NULL) OR ([userMail] = @Original_userMail)) AND ((@IsNull_Admin = 1 AND [Admin] IS NULL) OR ([Admin] = @Original_Admin)));
SELECT userID, userName, userPassword, userMail, Admin FROM Users WHERE (userID = @userID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT userID, userName, userPassword, userMail, Admin FROM dbo.Users";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT userID, userName, userPassword, userMail, Admin FROM dbo.Users";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT userID, userName, userPassword, userMail, Admin FROM dbo.Users WHERE userN" +
                "ame = @userName and userPassword = @userPassword";
            ...
            this._commandCollection[3].CommandText = "INSERT INTO [dbo].[Users] ([userID], [userName], [userPassword], [userMail], [Adm" +
                "in]) VALUES (@userID, @userName, @userPassword, @userMail, @Admin);";
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@userMail", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "userMail", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[4].CommandText = "UPDATE [dbo].[Users] SET [userName] = @userName, [userPassword] = @userPassword, " +
                "[userMail] = @userMail, [Admin] = @Admin WHERE userID = @Original_userID";
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@userMail", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "userMail", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual UsersDataSet.UsersDataTable GetAllUsers() {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual UsersDataSet.UsersDataTable GetUserByName(string userName, string userPassword) {
        ...
        public virtual int Delete(int Original_userID, string Original_userName, string Original_userPassword, string Original_userMail, global::System.Nullable<bool> Original_Admin) {
        ...
        public virtual int Insert(int userID, string userName, string userPassword, string userMail, global::System.Nullable<bool> Admin) {
        ...
        public virtual int Update(int userID, string userName, string userPassword, string userMail, global::System.Nullable<bool> Admin, int Original_userID, string Original_userName, string Original_userPassword, string Original_userMail, global::System.Nullable<bool> Original_Admin) {
            ...
            if ((Original_userMail == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_userMail));
            }
            if ((Original_Admin.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string userName, string userPassword, string userMail, global::System.Nullable<bool> Admin, int Original_userID, string Original_userName, string Original_userPassword, string Original_userMail, global::System.Nullable<bool> Original_Admin) {
            return this.Update(Original_userID, userName, userPassword, userMail, Admin, Original_userID, Original_userName, Original_userPassword, Original_userMail, Original_Admin);
        }
        ...
        public virtual int InsertUser(int userID, string userName, string userPassword, string userMail, global::System.Nullable<bool> Admin) {
            ...
            if ((userMail == null)) {
                ...
                command.Parameters[3].Value = ((string)(userMail));
            }
            if ((Admin.HasValue == true)) {
        ...
        public virtual int UpdateUser(string userName, string userPassword, string userMail, global::System.Nullable<bool> Admin, int Original_userID) {
            ...
            if ((Admin.HasValue == true)) {
                command.Parameters[3].Value = ((bool)(Admin.Value));
            }
            else {
                command.Parameters[3].Value = global::System.DBNull.Value;
            }
